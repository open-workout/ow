...
const wtUser1 = "auth0|wt-1"
const wtUser2 = "auth0|wt-2"
const wtUserWrong = "auth0|wt-wrong"
...
func TestCreateWorkout_Postgres(t *testing.T) {
	...
	if insertedUserID != workout.UserID {
		t.Fatalf("Wrong workout UserID: %s", insertedUserID)
	}
}
...
func TestGetWorkoutByID_Postgres(t *testing.T) {
	...
	if newWorkout.UserID != workout.UserID {
		t.Fatalf("Wrong workout UserID: %s", newWorkout.UserID)
	}
}
...
func TestAllowsSetsWithSameWorkoutIDAndExerciseID_Postgres(t *testing.T) {
	...
	setupSchema(t, db)
	repo := repository.NewSqlRepository(db)
	set1 := &domain.SetModel{WorkoutID: 100, ExerciseID: 1, Reps: 1, Difficulty: 2, Weight: 3, LoggedAt: time.Now()}
	set2 := &domain.SetModel{WorkoutID: 100, ExerciseID: 1, Reps: 1, Difficulty: 2, Weight: 3, LoggedAt: time.Now()}
...
func TestCreateSet_Postgres(t *testing.T) {
	...
	repo := repository.NewSqlRepository(db)
	workoutSet := &domain.SetModel{WorkoutID: 100, ExerciseID: 1, Reps: 10, Difficulty: 7, Weight: 80, LoggedAt: time.Now()}
...
func TestSetFinishTime_Postgres(t *testing.T) {
	...
	setupSchema(t, db)
	repo := repository.NewSqlRepository(db)
	workout := &domain.WorkoutModel{UserID: wtUser1, StartedAt: time.Now().Add(-1 * time.Hour)}
...
func TestSetFinishTimeAndGet_Postgres(t *testing.T) {
	...
	workout := &domain.WorkoutModel{UserID: wtUser1, StartedAt: time.Now()}
...
func TestGetLastTimeMax_Postgres(t *testing.T) {
	...
	setupSchema(t, db)
	repo := repository.NewSqlRepository(db)
	workout := &domain.WorkoutModel{UserID: wtUser1, StartedAt: time.Now().Add(-time.Hour)}
	workoutResult, err := repo.CreateWorkout(context.Background(), workout)
	if err != nil {
		t.Fatalf("Failed to create workout: %v", err)
	}

	set := &domain.SetModel{WorkoutID: workoutResult.WorkoutID, ExerciseID: 0, Reps: 1, Difficulty: 2, Weight: 100, LoggedAt: time.Now()}
	...
	lastWeightSet, err := repo.GetLastTimeMaxSet(context.Background(), wtUser1, 0)
	if err != nil {
...
func TestUpdateSet_Postgres(t *testing.T) {
	...
	workout, _ := repo.CreateWorkout(context.Background(), &domain.WorkoutModel{UserID: wtUser1, StartedAt: time.Now()})
	...
	updated, err := repo.UpdateSet(context.Background(), wtUser1, &domain.SetModel{
...
func TestUpdateSet_WrongUser_Postgres(t *testing.T) {
	...
	_, err := repo.UpdateSet(context.Background(), wtUserWrong, &domain.SetModel{
...
func TestUpdateSet_NotFound_Postgres(t *testing.T) {
	...
	_, err := repo.UpdateSet(context.Background(), wtUser1, &domain.SetModel{
...
func TestGetSetsByWorkoutID_Postgres(t *testing.T) {
	...
	sets, err := repo.GetSetsByWorkoutID(context.Background(), workout.WorkoutID, wtUser1)
	if err != nil {
		t.Fatalf("Failed to get sets: %v", err)
	}
	if len(sets) != 2 {
...
func TestGetSetsByWorkoutID_WrongUser_Postgres(t *testing.T) {
	...
	sets, err := repo.GetSetsByWorkoutID(context.Background(), workout.WorkoutID, wtUserWrong)
	if err != nil {
...
func TestDeleteWorkout_DoesNotAffectOtherWorkouts_Postgres(t *testing.T) {
	...
	w1, _ := repo.CreateWorkout(context.Background(), &domain.WorkoutModel{UserID: wtUser1, StartedAt: time.Now()})
	w2, _ := repo.CreateWorkout(context.Background(), &domain.WorkoutModel{UserID: wtUser1, StartedAt: time.Now()})
...
func TestDeleteSet_Postgres(t *testing.T) {
	...
	if err := repo.DeleteSet(context.Background(), wtUser1, set1.SetID); err != nil {
...
func TestDeleteSet_WrongUser_Postgres(t *testing.T) {
	...
	err := repo.DeleteSet(context.Background(), wtUserWrong, set.SetID)
	if err == nil {
...
func TestDeleteWorkoutsByUserID_Postgres(t *testing.T) {
	...
	w1, _ := repo.CreateWorkout(context.Background(), &domain.WorkoutModel{UserID: wtUser1, StartedAt: time.Now()})
	w2, _ := repo.CreateWorkout(context.Background(), &domain.WorkoutModel{UserID: wtUser1, StartedAt: time.Now()})
	w3, _ := repo.CreateWorkout(context.Background(), &domain.WorkoutModel{UserID: wtUser2, StartedAt: time.Now()})

	repo.CreateSet(context.Background(), &domain.SetModel{WorkoutID: w1.WorkoutID, ExerciseID: 1, Reps: 5})
	repo.CreateSet(context.Background(), &domain.SetModel{WorkoutID: w2.WorkoutID, ExerciseID: 1, Reps: 5})
	repo.CreateSet(context.Background(), &domain.SetModel{WorkoutID: w3.WorkoutID, ExerciseID: 1, Reps: 5})

	if err := repo.DeleteWorkoutsByUserID(context.Background(), wtUser1); err != nil {
		t.Fatalf("Failed to delete workouts by user: %v", err)
	}

	var workoutCount int
	db.QueryRow("SELECT COUNT(*) FROM workouts WHERE user_id = $1", wtUser1).Scan(&workoutCount)
	if workoutCount != 0 {
		t.Fatalf("Expected all user1 workouts deleted, got: %d", workoutCount)
	}

	var setCount int
	db.QueryRow("SELECT COUNT(*) FROM workout_sets WHERE workout_id IN ($1, $2)", w1.WorkoutID, w2.WorkoutID).Scan(&setCount)
	if setCount != 0 {
		t.Fatalf("Expected sets for user1 workouts deleted, got: %d", setCount)
	}

	var otherWorkoutCount int
	db.QueryRow("SELECT COUNT(*) FROM workouts WHERE user_id = $1", wtUser2).Scan(&otherWorkoutCount)
	if otherWorkoutCount != 1 {
		t.Fatalf("Expected user2 workout to remain, got: %d", otherWorkoutCount)
	}

	var otherSetCount int
	db.QueryRow("SELECT COUNT(*) FROM workout_sets WHERE workout_id = $1", w3.WorkoutID).Scan(&otherSetCount)
	if otherSetCount != 1 {
		t.Fatalf("Expected user2 sets to remain, got: %d", otherSetCount)
	}
}
...
func TestGetLastTimeMaxComplex_Postgres(t *testing.T) {
	...
	workout1 := &domain.WorkoutModel{UserID: wtUser1, StartedAt: time.Now().UTC().Add(-10 * time.Hour)}
	workout2 := &domain.WorkoutModel{UserID: wtUser1, StartedAt: time.Now().UTC().Add(-5 * time.Hour)}
	workout3 := &domain.WorkoutModel{UserID: wtUser1, StartedAt: time.Now().UTC().Add(-2 * time.Hour)}
	...
	_, err = repo.CreateSet(context.Background(), &domain.SetModel{
		WorkoutID: workoutResult1.WorkoutID, ExerciseID: 0, Reps: 5, Difficulty: 2, Weight: 100,
	...
	_, err = repo.CreateSet(context.Background(), &domain.SetModel{
		WorkoutID: workoutResult2.WorkoutID, ExerciseID: 0, Reps: 15, Difficulty: 2, Weight: 110,
	...
	_, err = repo.CreateSet(context.Background(), &domain.SetModel{
		WorkoutID: workoutResult3.WorkoutID, ExerciseID: 1, Reps: 10, Difficulty: 2, Weight: 200,
	...
	maxSet, err := repo.GetLastTimeMaxSet(context.Background(), wtUser1, 0)
	if err != nil {
